...
INPUT_LAS = '363-6649.las'
IMPORTED_SPD = 'testsuite1.spd'
INDEXED_SPD = 'testsuite1_idx.spd'
OUTPUT_DEM = 'testsuite1.img'

def run(tarFile, pathToUse='.'):
    """
    Runs the first basic test suite.
    """
    oldpath, newpath = utils.extractTarFile(tarFile, pathToUse)
    ...
    translate(info, inputLas, importedSPD, epsg=28355, 
